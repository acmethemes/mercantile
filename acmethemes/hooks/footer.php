...
if ( ! function_exists( 'mercantile_footer' ) ) :
	...
	function mercantile_footer() {
		...
		<footer class="site-footer at-remove-width <?php echo esc_attr( $bg_image_class ); ?>" style="<?php echo esc_attr( $bg_image_style ); ?>">
					...
					<div class="row">
						...
						if (
							...
							<div class="footer-columns">
								...
								if ( is_active_sidebar( 'mercantile-footer-top-col-two' ) ) :
									?>
									<div class="footer-sidebar init-animate fadeInDown1 <?php echo esc_attr( $footer_top_col ); ?>">
								...
								if ( is_active_sidebar( 'mercantile-footer-top-col-three' ) ) :
									?>
									<div class="footer-sidebar init-animate fadeInDown1 <?php echo esc_attr( $footer_top_col ); ?>">
