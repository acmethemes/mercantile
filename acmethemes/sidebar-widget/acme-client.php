...
if ( ! class_exists( 'Mercantile_client' ) ) {
    ...
    class Mercantile_client extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Page For Client', 'mercantile' ); ?>:</label>
                <br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'post_number' ) ); ?>"><?php _e( 'Client Number', 'mercantile' ); ?>:</label>
