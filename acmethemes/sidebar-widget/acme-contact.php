...
if ( ! class_exists( 'Mercantile_contact' ) ) {
    ...
    class Mercantile_contact extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'shortcode' ) ); ?>"><?php _e( 'Enter Shortcode', 'mercantile' ); ?>:</label>
                ...
                <small>
                    <?php
                    printf( __( 'Download contact form 7 from %1$sshere%2$s', 'mercantile' ), "<a target='_blank' href='".esc_url( 'https://wordpress.org/plugins/contact-form-7/' )."''>","</a>" );
                    ?>
                </small>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Page For Contact', 'mercantile' ); ?>:</label>
                <br />
        ...
        public function widget($args, $instance) {
            ...
            ?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="acme-widgets acme-contact">
                        ...
                        <div class="row">
                            ...
                            if( !empty ( $page_id ) ) :
                                ...
                                if ( $service_query->have_posts() ):
                                    ...
                                    ?>
                                        <div class="col-sm-6  <?php echo esc_attr( $animation2 ); ?>">
