...
if ( ! class_exists( 'Mercantile_portfolio' ) ) {
    ...
    class Mercantile_portfolio extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Parent Page For Portfolio', 'mercantile' ); ?>:</label>
                <br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'post_number' ) ); ?>"><?php _e( 'Portfolio Number', 'mercantile' ); ?>:</label>
        ...
        public function widget($args, $instance) {
            ...
            ?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="acme-widgets acme-portfolio">
