...
if ( ! class_exists( 'Mercantile_testimonial' ) ) {
    ...
    class Mercantile_testimonial extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Page For Testimonial', 'mercantile' ); ?>:</label>
                <br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'column_number' ) ); ?>"><?php _e( 'Number', 'mercantile' ); ?>:</label>
