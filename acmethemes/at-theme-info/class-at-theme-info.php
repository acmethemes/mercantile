...
if ( ! class_exists( 'Mercantile_Theme_Info' ) ) {
	class Mercantile_Theme_Info {
		...
		/**
		 * Get the theme info page config.
		 */
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'mercantile-theme-info-css', get_template_directory_uri() . '/acmethemes/at-theme-info/css/at-theme-info.css' );

			if ( 'appearance_page_' . $this->theme_slug . '-info' === $hook_suffix ) {

				wp_enqueue_script( 'mercantile-theme-info-js', get_template_directory_uri() . '/acmethemes/at-theme-info/js/at-theme-info.js', array( 'jquery' ) );
...
return new Mercantile_Theme_Info();
